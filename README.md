...
🛠 Technische Stack, Backend

Framework: ASP.NET Core 9.0 MVC
Database: SQL Server (LocalDB voor development)
...
SQL Server (LocalDB, Express, of Full)
Visual Studio 2022 (optioneel maar aanbevolen)


Git
Stap 1: Clone Repository
bashgit clone https://github.com/jouwnaam/safecasino.git
cd safecasino
Stap 2: NuGet Packages Herstellen
bashdotnet restore
Stap 3: Connection String Aanpassen
Open SafeCasino.Web/appsettings.json en pas indien nodig de connection string aan:
json{
  "ConnectionStrings": {
    "DefaultConnection": "Server=(localdb)\\mssqllocaldb;Database=SafeCasinoDB;Trusted_Connection=true;MultipleActiveResultSets=true"
  }
}

Stap 4: Database Aanmaken
bashcd SafeCasino.Web
...
Rol: Administrator
Saldo: €10,000
Rechten: Volledige toegang tot systeem
...
🎨 Design Features
Kleurenschema
css--primary-purple: #7c3aed      Hoofd paars
...
Toekomstige Features
 ...
 Live chat support
 Betalingsintegratie (Visa, Mastercard, PayPal)
 Multi-language support (Engels, Frans, Duits)
 Game demo modes
 VIP programma
 Cashback systeem
